...
const Board = ({ id, setIsModalNewTaskOpen }: BoardProps) => {
    // TODO: should not fetch tasks when update task status
    ...
    return (
        ...
        >
            {task.attachments && task.attachments.length > 0 && (
                <Image
                    src={`https://pm-s3-images-files.s3.eu-north-1.amazonaws.com/${task.attachments[0].fileURL}`}
                    ...
                    <div className='flex -space-x-[6px] overflow-hidden'>
                        {task.assignee && (
                            <Image
                                ...
                                src={`https://pm-s3-images-files.s3.eu-north-1.amazonaws.com/${task.assignee.profilePictureUrl}`}
                        ...
                        {task.author && (
                            <Image
                                ...
                                src={`https://pm-s3-images-files.s3.eu-north-1.amazonaws.com/${task.author.profilePictureUrl}`}
