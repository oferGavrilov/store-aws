            ...
            <div className='flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-[8px] pt-2 dark:border-stroke-dark md:items-center'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <div className='relative group'>
                        ...
                        />
                        <Grid3x3
                            className="absolute left-3 top-2 h-4 w-4 text-gray-400 dark:text-neutral-500 group-focus-within:text-white transition-colors duration-200"
                        />
                    </div>
                </div>
            </div>
...
const TabButton = ({ name, icon, setActiveTab, activeTab }: TabButtonProps) => {
    ...
    return (
        <button
            className={`relative flex items-center gap-2 px-1 py-2 text-gray-500 after:absolute after:-bottom-[9px] after:left-0 after:h-[1px] after:w-full hover:text-blue-600 dark:hover:text-white sm:px-2 lg:px-4 ${isActive ? "text-blue-600 after:bg-blue-600 dark:text-white" : "dark:text-neutral-500"
                }`}
